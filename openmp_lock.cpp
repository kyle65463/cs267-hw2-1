...
void add_to_cell(int particle_idx, particle_t& particle) {
    ...
    omp_set_lock(&grid.locks[cell_idx]);
    ...
    cell.size++;
    omp_unset_lock(&grid.locks[cell_idx]);
}
...
void init_simulation(particle_t* parts, int num_parts, double size) {
    ...
    grid.locks = new omp_lock_t[grid.nx * grid.ny];
...
// Threads: 64
// Simulation Time = 0.078716 seconds for 1000 particles.
// Simulation Time = 0.647438 seconds for 10000 particles.
// Simulation Time = 4.39668 seconds for 100000 particles.